...
static vgcanvas_nanovg_screen_shader_info_t* vgcanvas_create_init_screen_shader(bitmap_format_t format) {
  ...
  const char* fragment_shader_bgra =
      " #ifdef NANOVG_GL3                                      			\n"
  ...
  if(format == BITMAP_FMT_RGBA8888)
      shader_info->program_object =
          vgcanvas_create_LoadShader(vgcanvas_nanovg_shader_header, vertex_shader, fragment_shader_bgra);
  else
      shader_info->program_object =
          vgcanvas_create_LoadShader(vgcanvas_nanovg_shader_header, vertex_shader, fragment_shader_rgba);
...
vgcanvas_t* vgcanvas_create_jz_gl(uint32_t w, uint32_t h, uint32_t stride, bitmap_format_t format,
                            void* data) {
  ...
  nanovg->shader_program = vgcanvas_create_init_screen_shader(format);
