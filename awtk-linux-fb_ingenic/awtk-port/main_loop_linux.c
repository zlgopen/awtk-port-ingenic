...
#define FB_DEVICE_FILENAME getenv("TSLIB_FBDEVICE")
#define TS_DEVICE_FILENAME getenv("TSLIB_TSDEVICE")
#define KB_DEVICE_FILENAME getenv("KB_DEVICE_FILENAME")
#define MICE_DEVICE_FILENAME getenv("MICE_DEVICE_FILENAME")
