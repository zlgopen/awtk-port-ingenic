...
#ifndef TK_TEXT_HL_SELECTOR_H
#define TK_TEXT_HL_SELECTOR_H
...
typedef struct _text_hl_selector_option_t {
  int32_t value;
  struct _text_hl_selector_option_t* next;
  wchar_t text[2];
} text_hl_selector_option_t;

/**
 * @class text_hl_selector_t
 * @parent widget_t
 ...
 *
 * ```xml
 * <text_hl_selector options="red;green;blue;gold;orange" visible_nr="3" text="red"/>
 * ```
 *
 * > 更多用法请参考：[text\_selector.xml](
 * https://github.com/zlgopen/awtk/blob/master/demos/assets/raw/ui/text_hl_selector.xml)
 *
 * 在c代码中使用函数text\_selector\_create创建文本选择器控件。如：
 *
 * ```c
 * widget_t* ts = text_hl_selector_create(win, 10, 10, 80, 150);
 * text_hl_selector_set_options(ts, "1:red;2:green;3:blue;4:orange;5:gold");
 * text_hl_selector_set_value(ts, 1);
 * widget_use_style(ts, "dark");
 * ```
 *
 * > 完整示例请参考：[text\_selector demo](
 * https://github.com/zlgopen/awtk-c-demos/blob/master/demos/text_hl_selector.c)
 *
 ...
 *
 */
typedef struct _text_hl_selector_t {
  widget_t widget;
  ...
  text_hl_selector_option_t* option_items;
} text_hl_selector_t;
...
/**
 * @method text_hl_selector_create
 * 创建text_hl_selector对象
...
/**
 * @method text_hl_selector_cast
 * 转换text_hl_selector对象(供脚本语言使用)。
 * @annotation ["cast", "scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
 *
 * @return {widget_t*} text_hl_selector对象。
 */
widget_t* text_hl_selector_cast(widget_t* widget);

/**
 * @method text_hl_selector_reset_options
 * 重置所有选项。
...
/**
 * @method text_hl_selector_count_options
 * 获取选项个数。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
 *
...
/**
 * @method text_hl_selector_append_option
 * 追加一个选项。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
...
/**
 * @method text_hl_selector_set_options
 * 设置选项。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
...
/**
 * @method text_hl_selector_set_range_options
 * 设置一系列的整数选项。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
...
/**
 * @method text_hl_selector_get_option
 * 获取第index个选项。
 * @param {widget_t*} widget text_hl_selector对象。
 * @param {uint32_t} index 选项的索引。
 *
 * @return {text_hl_selector_option_t*} 成功返回选项，失败返回NULL。
 */
text_hl_selector_option_t* text_hl_selector_get_option(widget_t* widget, uint32_t index);

/**
 * @method text_hl_selector_get_value
 * 获取text_hl_selector的值。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
 *
 * @return {int32_t} 返回值。
...
/**
 * @method text_hl_selector_set_value
 * 设置text_hl_selector的值。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
 * @param {int32_t} value 值。
 *
...
/**
 * @method text_hl_selector_get_text
 * 获取text_hl_selector的文本。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
 *
 * @return {char*} 返回文本。
...
/**
 * @method text_hl_selector_set_text
 * 设置text_hl_selector的文本。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
...
/**
 * @method text_hl_selector_set_selected_index
 * 设置第index个选项为当前选中的选项。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
 * @param {uint32_t} index 选项的索引。
...
/**
 * @method text_hl_selector_set_visible_nr
 * 设置可见的选项数。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_hl_selector对象。
...
/**
 * @method text_hl_selector_set_loop_mode
 * 设置选中项的循环模式。
 * @annotation ["scriptable"]
 * @param {widget_t*} widget text_3d_selector对象。
 * @param {bool_t} loop 循环模式。
 *
 * @return {ret_t} 返回RET_OK表示成功，否则表示失败。
 */
ret_t text_hl_selector_set_loop_mode(widget_t* widget, bool_t loop);

#define SELECTOR_LOOP_MODE "loop"
#define TEXT_HL_SELECTOR_PROP_VISIBLE_NR "visible_nr"
#define WIDGET_TYPE_TEXT_HL_SELECTOR "text_hl_selector"
#define TEXT_HL_SELECTOR(widget) ((text_hl_selector_t*)(text_hl_selector_cast(WIDGET(widget))))

/*public for subclass and runtime type check*/
TK_EXTERN_VTABLE(text_hl_selector);
