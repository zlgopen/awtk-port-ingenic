...
typedef struct _jh_mem_t {
    ...
    uint32_t w_align;  // width algin, unit: pixel. for GPU: 64.
    uint32_t h_align; // height algin, unit: pixel. for GPU: 16.
    uint32_t w_align_unit;  // width algin specified, unit: pixel. for GPU: 64.
    uint32_t h_align_unit; // height algin specified, unit: pixel. for GPU: 16.
